...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl('https://github.com/embyovo/lx-music-mobile#readme')
  }
  const openIssuePage = () => {
    void openUrl('https://github.com/embyovo/lx-music-mobile/issues?q=is%3Aissue+')
  }
  const openGHReleasePage = () => {
    void openUrl('https://github.com/embyovo/lx-music-mobile/releases')
  }
  const openFAQPage = () => {
    ...
    <Section title={t('setting_about')}>
      <View style={styles.part}>
        ...
        <TouchableOpacity onPress={openHomePage}>
          <Text style={textLinkStyle}>https://github.com/embyovo/lx-music-mobile</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.part}>
