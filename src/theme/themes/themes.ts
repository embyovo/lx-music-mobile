...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(0, 217, 132)",
        "c-primary-dark-100": "rgb(0,195,119)",
        "c-primary-dark-100-alpha-100": "rgba(0, 195, 119, 0.90)",
        "c-primary-alpha-100": "rgba(0, 217, 132, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(0, 195, 119, 0.80)",
        "c-primary-alpha-200": "rgba(0, 217, 132, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(0, 195, 119, 0.70)",
        "c-primary-alpha-300": "rgba(0, 217, 132, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(0, 195, 119, 0.60)",
        "c-primary-alpha-400": "rgba(0, 217, 132, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(0, 195, 119, 0.50)",
        "c-primary-alpha-500": "rgba(0, 217, 132, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(0, 195, 119, 0.40)",
        "c-primary-alpha-600": "rgba(0, 217, 132, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(0, 195, 119, 0.30)",
        "c-primary-alpha-700": "rgba(0, 217, 132, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(0, 195, 119, 0.20)",
        "c-primary-alpha-800": "rgba(0, 217, 132, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(0, 195, 119, 0.10)",
        "c-primary-alpha-900": "rgba(0, 217, 132, 0.10)",
        "c-primary-dark-200": "rgb(0,176,107)",
        "c-primary-dark-200-alpha-100": "rgba(0, 176, 107, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(0, 176, 107, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(0, 176, 107, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(0, 176, 107, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(0, 176, 107, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(0, 176, 107, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(0, 176, 107, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(0, 176, 107, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(0, 176, 107, 0.10)",
        "c-primary-dark-300": "rgb(0,158,96)",
        "c-primary-dark-300-alpha-100": "rgba(0, 158, 96, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(0, 158, 96, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(0, 158, 96, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(0, 158, 96, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(0, 158, 96, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(0, 158, 96, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(0, 158, 96, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(0, 158, 96, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(0, 158, 96, 0.10)",
        "c-primary-dark-400": "rgb(0,142,86)",
        "c-primary-dark-400-alpha-100": "rgba(0, 142, 86, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(0, 142, 86, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(0, 142, 86, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(0, 142, 86, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(0, 142, 86, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(0, 142, 86, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(0, 142, 86, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(0, 142, 86, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(0, 142, 86, 0.10)",
        "c-primary-dark-500": "rgb(0,128,77)",
        "c-primary-dark-500-alpha-100": "rgba(0, 128, 77, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(0, 128, 77, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(0, 128, 77, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(0, 128, 77, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(0, 128, 77, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(0, 128, 77, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(0, 128, 77, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(0, 128, 77, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(0, 128, 77, 0.10)",
        "c-primary-dark-600": "rgb(0,115,69)",
        "c-primary-dark-600-alpha-100": "rgba(0, 115, 69, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(0, 115, 69, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(0, 115, 69, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(0, 115, 69, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(0, 115, 69, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(0, 115, 69, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(0, 115, 69, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(0, 115, 69, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(0, 115, 69, 0.10)",
        "c-primary-dark-700": "rgb(0,104,62)",
        "c-primary-dark-700-alpha-100": "rgba(0, 104, 62, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(0, 104, 62, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(0, 104, 62, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(0, 104, 62, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(0, 104, 62, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(0, 104, 62, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(0, 104, 62, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(0, 104, 62, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(0, 104, 62, 0.10)",
        "c-primary-dark-800": "rgb(0,94,56)",
        "c-primary-dark-800-alpha-100": "rgba(0, 94, 56, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(0, 94, 56, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(0, 94, 56, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(0, 94, 56, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(0, 94, 56, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(0, 94, 56, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(0, 94, 56, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(0, 94, 56, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(0, 94, 56, 0.10)",
        "c-primary-dark-900": "rgb(0,85,50)",
        "c-primary-dark-900-alpha-100": "rgba(0, 85, 50, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(0, 85, 50, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(0, 85, 50, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(0, 85, 50, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(0, 85, 50, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(0, 85, 50, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(0, 85, 50, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(0, 85, 50, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(0, 85, 50, 0.10)",
        "c-primary-dark-1000": "rgb(0,77,45)",
        "c-primary-dark-1000-alpha-100": "rgba(0, 77, 45, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(0, 77, 45, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(0, 77, 45, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(0, 77, 45, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(0, 77, 45, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(0, 77, 45, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(0, 77, 45, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(0, 77, 45, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(0, 77, 45, 0.10)",
        "c-primary-light-100": "rgb(51,225,157)",
        "c-primary-light-100-alpha-100": "rgba(51, 225, 157, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(51, 225, 157, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(51, 225, 157, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(51, 225, 157, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(51, 225, 157, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(51, 225, 157, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(51, 225, 157, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(51, 225, 157, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(51, 225, 157, 0.10)",
        "c-primary-light-200": "rgb(92,231,177)",
        "c-primary-light-200-alpha-100": "rgba(92, 231, 177, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(92, 231, 177, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(92, 231, 177, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(92, 231, 177, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(92, 231, 177, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(92, 231, 177, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(92, 231, 177, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(92, 231, 177, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(92, 231, 177, 0.10)",
        "c-primary-light-300": "rgb(125,236,193)",
        "c-primary-light-300-alpha-100": "rgba(125, 236, 193, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(125, 236, 193, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(125, 236, 193, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(125, 236, 193, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(125, 236, 193, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(125, 236, 193, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(125, 236, 193, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(125, 236, 193, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(125, 236, 193, 0.10)",
        "c-primary-light-400": "rgb(151,240,205)",
        "c-primary-light-400-alpha-100": "rgba(151, 240, 205, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(151, 240, 205, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(151, 240, 205, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(151, 240, 205, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(151, 240, 205, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(151, 240, 205, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(151, 240, 205, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(151, 240, 205, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(151, 240, 205, 0.10)",
        "c-primary-light-500": "rgb(172,243,215)",
        "c-primary-light-500-alpha-100": "rgba(172, 243, 215, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(172, 243, 215, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(172, 243, 215, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(172, 243, 215, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(172, 243, 215, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(172, 243, 215, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(172, 243, 215, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(172, 243, 215, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(172, 243, 215, 0.10)",
        "c-primary-light-600": "rgb(189,245,223)",
        "c-primary-light-600-alpha-100": "rgba(189, 245, 223, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(189, 245, 223, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(189, 245, 223, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(189, 245, 223, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(189, 245, 223, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(189, 245, 223, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(189, 245, 223, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(189, 245, 223, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(189, 245, 223, 0.10)",
        "c-primary-light-700": "rgb(202,247,229)",
        "c-primary-light-700-alpha-100": "rgba(202, 247, 229, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(202, 247, 229, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(202, 247, 229, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(202, 247, 229, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(202, 247, 229, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(202, 247, 229, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(202, 247, 229, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(202, 247, 229, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(202, 247, 229, 0.10)",
        "c-primary-light-800": "rgb(213,249,234)",
        "c-primary-light-800-alpha-100": "rgba(213, 249, 234, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(213, 249, 234, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(213, 249, 234, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(213, 249, 234, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(213, 249, 234, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(213, 249, 234, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(213, 249, 234, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(213, 249, 234, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(213, 249, 234, 0.10)",
        "c-primary-light-900": "rgb(221,250,238)",
        "c-primary-light-900-alpha-100": "rgba(221, 250, 238, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(221, 250, 238, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(221, 250, 238, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(221, 250, 238, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(221, 250, 238, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(221, 250, 238, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(221, 250, 238, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(221, 250, 238, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(221, 250, 238, 0.10)",
